...
async function encodeImageFile(file, signal) {
  if (typeof file === "string" && file.toLowerCase().endsWith(".gif") && (await isAnimatedGif(file)) === true) {
    return videoFileToDataUri(file, signal, { gif: true })
  }
...
export { DOCUMENT_MIMES, mediaToFile, sniffMediaKind, imageFileToDataUri, videoFileToDataUri, audioFileToDataUri, fileToDataUri, isAnimatedGif, classifyFileExt, encodeImageFile }
