...
async function imageFileToDataUri(file) {
  ...
  const quality = (await stat(file)).size < IMAGE_FAST_THRESHOLD ? 100 : 90
...
export { GEMINI_DOCUMENT_MIMES, mediaToFile, sniffMediaKind, imageFileToDataUri, videoFileToDataUri, audioFileToDataUri, fileToDataUri, isAnimatedGif }
