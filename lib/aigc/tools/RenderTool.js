...
tools.register({
  name: "render",
  description:
    "Render Markdown/HTML as an image or video and send to the chat. Use when your reply has tables, code blocks, or complex formatting that benefits from visual presentation. format='video' for animations or video content.",
  parameters: {
    type: "object",
    properties: {
      ...
      format: {
        ...
        enum: ["image", "video"],
        description:
          "Output format. 'image' for static screenshot (default), 'video' for animated HTML or embedded video.",
      },
      duration: {
        type: "number",
