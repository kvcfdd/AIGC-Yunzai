...
tools.register({
  name: "search",
  description: "Search the internet for web pages, images, music, or videos. Use when you need real-time info or want to find media to share. After searching the web, browse specific results for more details.",
  parameters: {
    type: "object",
    properties: {
