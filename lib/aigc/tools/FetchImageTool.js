...
tools.register({
  name: "fetch_image",
  description: "Download and view an image from a URL. Use when you need to see what an image looks like — for example, a user's avatar, a photo they mention, or any image URL you encounter.",
  parameters: {
    type: "object",
    properties: {
      url: {
        type: "string",
        description: "Image URL to fetch and view. Supports http/https URLs and data URIs.",
      },
      referer: {
        type: "string",
        description: "Referer from the search result (image search returns 'Referer' field). REQUIRED for most image CDNs — without it the download will fail.",
      },
    },
    required: ["url"],
  },
