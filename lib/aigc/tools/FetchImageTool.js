...
tools.register({
  name: "fetch_image",
  description:
    "Download and view an image from a URL. Use when you need to see what an image looks like — for example, a user's avatar, a photo they mention, or any image URL you encounter. Always pass the 'referer' from search results (e.g. image search) — this is REQUIRED for most image sources to avoid being blocked.",
  parameters: {
    type: "object",
    properties: {
      url: {
