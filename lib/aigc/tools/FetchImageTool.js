...
tools.register({
  name: "fetch_media",
  description: "Download and view an image or video from a URL. Use when you need to see a media file — for example, a user's avatar, a photo they mention, or any image/video URL you encounter. Automatically add Referer and use a proxy to bypass hotlink protection for pixiv images (i.pximg.net).",
  parameters: {
    type: "object",
    properties: {
      url: {
